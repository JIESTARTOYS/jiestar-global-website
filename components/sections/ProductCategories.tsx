                ...
                >
                  <div className="relative aspect-square overflow-hidden bg-slate-50 sm:aspect-[4/3]">
                    {category.image ? (
                      <Image
                        src={category.image}
                        alt={category.imageAlt ?? `${category.title} collection`}
                        fill
                        sizes="13rem"
                        draggable={false}
                  ...
                  <div className="flex min-h-16 items-end justify-between gap-2 p-2.5 sm:min-h-[76px] sm:gap-3 sm:p-3">
                    <div className="min-w-0">
                      <h3 className="line-clamp-2 text-xs font-black leading-4 text-slate-950 transition group-hover:text-red-600 sm:text-sm sm:leading-5">{category.title}</h3>
                      <p className="mt-1 text-[11px] font-semibold leading-3.5 text-slate-500 sm:text-xs sm:leading-4">{category.productCount} products</p>
                    </div>
