  ...
  return (
    <div className="bg-white px-5 py-16 lg:px-8">
      <div className="mx-auto max-w-3xl rounded-lg border border-slate-200 bg-slate-50 p-8 text-center shadow-sm shadow-slate-950/[0.03]">
        ...
        <h1 className="mt-3 text-3xl font-black text-slate-950">This product is taking longer to load.</h1>
        <p className="mt-4 text-base leading-8 text-slate-600">
          Shopify product data is temporarily unavailable. Retry the request or browse the product catalog while the connection recovers.
        </p>
