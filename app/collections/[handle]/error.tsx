  ...
  return (
    <div className="bg-white px-5 py-16 lg:px-8">
      <div className="mx-auto max-w-3xl rounded-lg border border-slate-200 bg-slate-50 p-8 text-center shadow-sm shadow-slate-950/[0.03]">
        <p className="text-sm font-black uppercase text-red-600">Collection data unavailable</p>
        <h1 className="mt-3 text-3xl font-black text-slate-950">This Shopify collection could not be loaded.</h1>
        <p className="mt-4 text-base leading-8 text-slate-600">
          Collection data is managed in Shopify. Check the Vercel server logs for the Shopify data-source diagnostic before redeploying.
        </p>
